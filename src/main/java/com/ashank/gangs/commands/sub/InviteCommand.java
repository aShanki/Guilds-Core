...
public class InviteCommand {
    ...
    private static int executeInvite(CommandContext<CommandSourceStack> context, GangsPlugin plugin, Storage storageManager, Messages messages, MiniMessage miniMessage) {
